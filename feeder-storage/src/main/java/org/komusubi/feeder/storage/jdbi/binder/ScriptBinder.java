 ...
 * @author jun.ozeki
 */
@BindingAnnotation(ScriptBinder.ScriptBinderFactory.class)
@Retention(RetentionPolicy.RUNTIME)
@Target({ElementType.PARAMETER})
public @interface ScriptBinder {

    public static class ScriptBinderFactory implements BinderFactory {
        ...
        public Binder<? extends Annotation, Script> build(Annotation annotation) {
            return new Binder<ScriptBinder, Script>() {
